...
OledDisplay::OledDisplay(esp_lcd_panel_io_handle_t panel_io,
...
void OledDisplay::SetupUI_128x64() {
  ...
  lv_obj_set_flex_align(top_bar_, LV_FLEX_ALIGN_SPACE_BETWEEN,
  ...
  lv_obj_set_style_bg_opa(status_bar_, LV_OPA_TRANSP,
                          0); // Transparent background
  lv_obj_set_style_border_width(status_bar_, 0, 0);
  lv_obj_set_style_pad_all(status_bar_, 0, 0);
  lv_obj_set_scrollbar_mode(status_bar_, LV_SCROLLBAR_MODE_OFF);
  lv_obj_set_style_layout(status_bar_, LV_LAYOUT_NONE,
                          0);                        // Use absolute positioning
  ...
  lv_obj_set_style_anim_duration(
      chat_message_label_, lv_anim_speed_clamped(60, 300, 60000), LV_PART_MAIN);

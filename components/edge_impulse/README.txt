...
# Edge Impulse library for ESP32S3BOX3-IMU

This is a C++ library that lets you run the impulse for "ESP32S3BOX3-IMU" (https://studio.edgeimpulse.com/studio/881780) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
